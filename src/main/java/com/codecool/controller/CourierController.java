...
public class CourierController {
    ...
    public List<CourierOrderDto> getMyCurrentJobs() {
        Users user = userRepository.findByName(simpleUserService.getCurrentUser().getName());
    ...
    void pickUpJob(@RequestBody CartIdDto cartId) {
        Users courier = userRepository.findByName(simpleUserService.getCurrentUser().getName());
